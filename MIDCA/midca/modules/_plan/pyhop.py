...
def pyhop(state,tasks,verbose=2):
    """
...
def seek_plan(state,tasks,plan,depth,verbose = 3):
    """
    ...
    print("List of tasks" + str(tasks))

    task1 = tasks[0]
    print("First task" + str(task1) )
    print("Print task "+ str(task1[0]))
    """ LOOK HERE"""
    ...
    if task1[0] in methods:
        ...
        print("Relavant" + str(relevant))
        print("Task 1 1"+ str(task1[1:]))
        for method in relevant:
            print("...... For subtasks = " +  str(task1[1:]))
